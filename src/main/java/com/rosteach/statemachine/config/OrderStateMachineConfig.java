...
import com.rosteach.statemachine.action.S1Action;
import com.rosteach.statemachine.action.S2Action;
import com.rosteach.statemachine.action.error.S1ActionError;
import com.rosteach.statemachine.action.error.S2ActionError;
...
public class OrderStateMachineConfig extends EnumStateMachineConfigurerAdapter<States, Events> {
	...
	private final S1ActionError s1ActionError;
	private final S2ActionError s2ActionError;
